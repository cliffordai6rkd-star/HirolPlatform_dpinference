...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from learning_factory.cameras.opencv import OpenCVCamera
        from learning_factory.cameras.configuration_opencv import OpenCVCameraConfig, ColorMode, Cv2Rotation
