...
from learning_factory.policies.utils import get_device_from_parameters
...
if __name__ == "__main__":
    main()
# python learning_factory/scripts/lerobot_train_single.py --config_path=learning_factory/configs/train_dp_local.json
# python learning_factory/scripts/lerobot_train_single.py --config_path=/home/hanyu/code/HIROLRobotPlatform/outputs/train/fr3_act_local_joint_2/checkpoints/last/pretrained_model/train_config.json --resume true